...
- [ ] The project should have [.gitattributes](https://github.com/pamelafox/django-quiz-app/blob/main/.gitattributes) to reduce CLRF related issues across Mac/Windows/Linux.
